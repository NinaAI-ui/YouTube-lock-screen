...
function updateBackground() {
    ...
    if (hour >= 5 && hour < 11) {
        ...
        // 🔴 CORREÇÃO: Força a cor do texto do body para escuro (para contraste no fundo claro)
        ...
        // 🔴 CORREÇÃO: Força a cor do texto do body para claro (para contraste no fundo escuro)
...
// -----------------------------------------------------
// LÓGICA DAS PARTÍCULAS (APENAS ESTÉTICA, SEPARADA POR LIMPEZA)
// -----------------------------------------------------
...
document.addEventListener('DOMContentLoaded', () => {
    // A lógica de fundo já é chamada e atualizada pelo setInterval
    // Apenas inicializa as partículas no carregamento
